...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg opacity-70 ring-offset-white cursor-pointer transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-[#00B8FF]/30 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-[#F1F5F9] data-[state=open]:text-[#64748B]">
        <X className="h-4 w-4" />
